...
export class FakeInititalData implements OnApplicationBootstrap {
  private fakeProducts = [
    ...
    },
    {
      ...
      stock: 20,
      price: 1299.99,
      imageUrl: 'https://example.com/images/laptop-g200.jpg',
      category: { name: 'Eletrônicos' },
    },
    {
      ...
      stock: 100,
      price: 89.99,
      imageUrl: 'https://example.com/images/keyboard-mk900.jpg',
      category: { name: 'Eletrônicos' },
    },
    {
    ...
    },
    {
      ...
      stock: 10,
      price: 499.99,
      imageUrl: 'https://example.com/images/camera-xz50.jpg',
      category: { name: 'Eletrônicos' },
    },
    {
    ...
    },
    {
      ...
      stock: 8,
      price: 799.99,
      imageUrl: 'https://example.com/images/electric-scooter.jpg',
    ...
    },
    {
      ...
      stock: 40,
      price: 199.99,
      imageUrl: 'https://example.com/images/smartwatch-z10.jpg',
      category: { name: 'Eletrônicos' },
    },
  ];
